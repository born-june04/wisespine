# Modified imports for standalone usage
try:
    ...
    def profile(func):
        return func
    def log_gradient_norm(*args, **kwargs):
        pass
...
# Lazy import DGL to avoid circular import issues
# DGL will be imported when actually needed
try:
import dgl
